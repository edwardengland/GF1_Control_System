function results = evaluate(run_title, out, trigger, total)
    %consts
    ...
    for i = 1:6
        ...
        if i <= 3
            perf(i) = Abhi_Evaluation.evaluateinputperf(t, data, setpoints(i));
        else
            perf(i) = Abhi_Evaluation.evaluateoutputperf(t, data, setpoints(i));
        end
        sat_perf(i) = Abhi_Evaluation.evaluatesat(t, data, setpoints(i));
    end
